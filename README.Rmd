...
The model file contains the mean parameter set — as presented in the supplementary appendix of [3] — so this is used in calculations by default. However, it can be changed in R (without changing the model file) as this is only a specification for defaults, and can be overridden.
